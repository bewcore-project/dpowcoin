...
const std::string CURRENCY_UNIT = "DPC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    DPC_KVB,      //!< Use DPC/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::DPC_KVB) const;
