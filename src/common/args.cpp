...
const char * const BITCOIN_CONF_FILENAME = "dpowcoin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Dpowcoin
    // macOS: ~/Library/Application Support/Dpowcoin
    // Unix-like: ~/.dpowcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Dpowcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Dpowcoin";
#else
    // Unix-like
    return pathRet / ".dpowcoin";
#endif
#endif
}
