...
BOOST_AUTO_TEST_CASE(test_LocaleIndependentAtoi)
{
    ...
    // Ensure legacy compatibility with previous versions of Dpowcoin Core's atoi64
    for (const auto& pair : atoi64_test_pairs) {
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("dpowcoin"), "Dpowcoin");
...
BOOST_AUTO_TEST_CASE(message_sign)
{
    const std::array<unsigned char, 32> privkey_bytes = {
        ...
        // derived address from this private key: PCnc7E2pUjkkKLphUN6pbPcBLjoDCAZaiw
    ...
    const std::string expected_signature =
        "II1XLQ2+fRtLPs19vFmTcpezWAd/RSValw+RD0X6CkevexopmptHrzvzFq85RjzITD16O9aqPNvJfmuM9+P1zsk=";
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "PTRmLnjp8AeckJ3yQZtJt7npMVeowVAVru",
...
BOOST_AUTO_TEST_CASE(util_WriteBinaryFile)
{
    ...
    std::string expected_text = "dpowcoin";
