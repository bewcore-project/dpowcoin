...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Dpowcoin relies on 80 byte header hashes, we want to have an example for that.",
               "97afb96ada4090fbe922b5e370f213672ed47bcee761f6fc52b2e37e34a4b8f2");
