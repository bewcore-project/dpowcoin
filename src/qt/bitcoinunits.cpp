...
static constexpr auto MAX_DIGITS_DPC = 16;
...
QList<BitcoinUnit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(Unit::mDPC);
    unitlist.append(Unit::uDPC);
...
QString BitcoinUnits::longName(Unit unit)
{
    ...
    case Unit::mDPC: return QString("mDPC");
    case Unit::uDPC: return QString::fromUtf8("µDPC (bits)");
...
QString BitcoinUnits::shortName(Unit unit)
{
    ...
    case Unit::mDPC: return longName(unit);
    case Unit::uDPC: return QString("bits");
...
{
    switch (unit) {
    case Unit::DPC: return QString("Dpowcoins");
    case Unit::mDPC: return QString("Milli-Dpowcoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uDPC: return QString("Micro-Dpowcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
qint64 BitcoinUnits::factor(Unit unit)
{
    ...
    case Unit::mDPC: return 100'000;
    case Unit::uDPC: return 100;
...
int BitcoinUnits::decimals(Unit unit)
{
    ...
    case Unit::mDPC: return 5;
    case Unit::uDPC: return 2;
...
QString BitcoinUnits::format(Unit unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool justify)
{
    ...
    if (justify) {
        quotient_str = quotient_str.rightJustified(MAX_DIGITS_DPC - num_decimals, ' ');
    }
...
qint8 ToQint8(BitcoinUnit unit)
{
    ...
    case BitcoinUnit::mDPC: return 1;
    case BitcoinUnit::uDPC: return 2;
...
BitcoinUnit FromQint8(qint8 num)
{
    ...
    case 1: return BitcoinUnit::mDPC;
    case 2: return BitcoinUnit::uDPC;
