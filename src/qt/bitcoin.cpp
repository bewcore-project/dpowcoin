...
static const char* qt_argv = "dpowcoin-qt";
...
int GuiMain(int argc, char* argv[])
{
    ...
    /// 6-7. Parse dpowcoin.conf, determine network, switch to network specific
    ...
    // dpowcoin: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
