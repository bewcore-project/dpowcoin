...
""" Interactive dpowcoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Dpowcoin Core can enable. It uses BCC
...
def main(dpowcoind_path):
    ...
    dpowcoind_with_usdts.enable_probe(
