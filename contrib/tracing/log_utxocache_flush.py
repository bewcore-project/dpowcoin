...
"""Example logging Dpowcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/dpowcoind
...
def main(dpowcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[dpowcoind_with_usdts])
