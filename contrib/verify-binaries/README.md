...
As of Dpowcoin Core v26.1, releases are signed by a number of public keys on the basis
...
signature file `SHA256SUMS.asc` from https://dpowcore.org and https://dpowcore.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/dpowcoin-26.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/dpowcoin-26.1-arm-linux-gnueabihf.tar.gz
```
