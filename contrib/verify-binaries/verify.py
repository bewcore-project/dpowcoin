...
"""Script for verifying Dpowcoin Core release binaries.

This script attempts to download the sum file SHA256SUMS and corresponding
signature file SHA256SUMS.asc from dpowcore.org and bitcoin.org and
compares them.
...
HOST1 = "https://dpowcore.org"
HOST2 = "https://dpowcore.org"
VERSIONPREFIX = "dpowcoin-"
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    ...
    # remove binaries that are known not to be hosted by dpowcore.org
...
def main():
    ...
    pub_parser.add_argument(
        'version', type=str, help=(
            f'version of the dpowcoin release to download; of the format '
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes dpowcore.org lags behind dpowcore.org.)')
    )
