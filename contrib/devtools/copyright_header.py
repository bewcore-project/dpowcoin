...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The Dpowcoin Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a dpowcoin source code repository.
...
Arguments:
    <file> - A source file in the dpowcoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Dpowcoin
