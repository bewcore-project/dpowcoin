...
"""Verify that starting dpowcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dpowcoin with -h for help text")
        ...
        self.log.info("Start dpowcoin with -version for version information")
        ...
        self.log.info("Start dpowcoind with -fakearg to make sure it does not start")
