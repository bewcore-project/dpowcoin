...
"""Test framework for dpowcoin utils.
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./dpowcoin-util":
        execprog = os.getenv("BITCOINUTIL", default=execprog)
    elif testObj["exec"] == "./dpowcoin-tx":
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, dpowcoin-tx
